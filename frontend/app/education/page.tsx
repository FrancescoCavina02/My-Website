                ...
                <div className="max-w-3xl mx-auto">
                    ...
                    <div className="space-y-8 animate-fade-in-up">
                        <TimelineItem
                            ...
                            institution="Vrije Universiteit Amsterdam, Amsterdam"
                            description="Bachelor's student focusing on artificial intelligence, data engineering, and software engineering principles."
                            highlights={[
                                "Core focus areas: machine learning, algorithms, and data systems.",
                                "Applied work includes full-stack AI products and production APIs.",
                            ]}
                            current
                        />
                    </div>
