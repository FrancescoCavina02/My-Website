            ...
            <section className="section">
                <div className="max-w-3xl mx-auto">
                    ...
                    <div className="space-y-8 animate-fade-in-up">
                        <div className="card">
                            <h2 className="text-xl font-semibold mb-4 text-white border-b border-[var(--color-divider)] pb-3">
                                Introduction
                            </h2>
                            <div className="prose prose-invert max-w-none text-[var(--color-text-secondary)]">
                                ...
                                <p className="leading-relaxed font-light">
                                    My long-term direction is to keep deepening both ML fundamentals and applied AI engineering so I can build robust, context-aware systems that are useful in real-world environments.
                                </p>
                            </div>
                        </div>

                        <div className="card">
                            <h2 className="text-xl font-semibold mb-6 text-white border-b border-[var(--color-divider)] pb-3">
                                Technical Skills
                            </h2>
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                                ...
                                <div>
                                    ...
                                    <div className="flex flex-wrap gap-2">
                                        <span className="tag border-[var(--color-accent-border)] text-[var(--color-accent)]">LLMs</span>
                                        <span className="tag border-[var(--color-accent-border)] text-[var(--color-accent)]">RAG</span>
                        ...
                        <div className="card">
                            ...
                            <div className="prose prose-invert max-w-none text-[var(--color-text-secondary)] font-light">
                                <p>
                                    Finishing my BSc in Computer Science at Vrije Universiteit Amsterdam while building AI-powered products and exploring practical research directions in NLP and intelligent systems.
                                </p>
                            </div>
                        </div>
