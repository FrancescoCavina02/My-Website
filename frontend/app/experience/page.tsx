                        ...
                        <div className="relative pl-8 border-l border-[rgba(255,255,255,0.1)]">
                            ...
                            <div className="card">
                                ...
                                <div className="flex flex-wrap justify-between items-start gap-4 mb-6">
                                    <div>
                                        <h2 className="text-2xl font-bold text-white mb-1">AI & Data Platform Engineer</h2>
                                ...
                                <div className="mb-8 pb-6 border-b border-[rgba(255,255,255,0.05)]">
                                    ...
                                    <p className="text-[var(--color-text-secondary)] leading-relaxed">
                                        <span className="text-white font-medium">Platform Engineering / AI & Data Infrastructure</span> — building the core platform that enables privacy-first, self-service data and LLM capabilities for enterprise clients.
                                    </p>
                                </div>
                                ...
                                <div className="mb-8">
                                    ...
                                    <div className="flex flex-wrap gap-2">
                                        {[
                                            "Python", "PySpark", "SQL", "Apache Spark", "Airflow", "Azure", "Kubernetes", "Terraform", "Docker", "Ollama", "OpenWebUI", "MCPs", "SQLAlchemy", "WireGuard"
                                        ].map((tech) => (
                                ...
                                <div>
                                    ...
                                    <div className="grid grid-cols-1 md:grid-cols-2 gap-x-8 gap-y-2">
                                        {[
                                            ...
                                            <div key={i} className="text-[var(--color-text-secondary)] text-xs flex items-center gap-2">
